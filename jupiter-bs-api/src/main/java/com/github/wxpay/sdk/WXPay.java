...
public class WXPay {
    ...
    /**
     * 统一下单后，获取调起微信支付所需信息，返回给app
     * @param reqData
     * @return
     * @throws Exception
     */
    public Map<String, String> getAppPayInfoMap(Map<String, String> reqData) throws Exception {
        SortedMap<String, String> getSignMap = new TreeMap<>();
        getSignMap.put("appid", config.getAppID());
        getSignMap.put("partnerid", config.getMchID());
        getSignMap.put("prepayid", reqData.get("prepay_id"));
//        getSignMap.put("noncestr", WXPayUtil.generateNonceStr());
        getSignMap.put("noncestr", reqData.get("nonce_str"));
        getSignMap.put("timestamp", String.valueOf(getSecondTimestamp(new Date())));
        getSignMap.put("package", "Sign=WXPay");
//        if (SignType.MD5.equals(this.signType)) {
//            getSignMap.put("sign_type", WXPayConstants.MD5);
//        }
//        else if (SignType.HMACSHA256.equals(this.signType)) {
//            getSignMap.put("sign_type", WXPayConstants.HMACSHA256);
//        }
        String sign = WXPayUtil.generateSignature(getSignMap, config.getKey(), this.signType);
        getSignMap.put("sign",sign);
    ...
    /**
     * 商户主动查询微信订单信息，获取签名入参
     * @param wechatOrderInfoParam
     * @return
     * @throws Exception
     */
    public Map<String, String> getSignOfOrderQuery(WechatOrderInfoParam wechatOrderInfoParam) throws Exception {
        SortedMap<String, String> getParamMap = new TreeMap<>();
        getParamMap.put("appid", wechatOrderInfoParam.getAppid());
        getParamMap.put("mch_id", wechatOrderInfoParam.getMch_id());
        getParamMap.put("out_trade_no", wechatOrderInfoParam.getOut_trade_no());
        getParamMap.put("nonce_str", WXPayUtil.generateNonceStr());

        String sign = WXPayUtil.generateSignature(getParamMap, config.getKey(), this.signType);
